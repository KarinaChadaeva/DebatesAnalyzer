...
## Project structure
├── debates_explorer.py   # пользовательский интерфейс для анализа дебатов

├── debates_explorer.py   # пользовательский интерфейс для анализа политиков
...
Он работает на уже отфильтрованных объектах Debate и предназначен для корпусного и сравнительного анализа дискурса президентских дебатов.
